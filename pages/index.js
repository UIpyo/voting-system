  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.navbar}>
        ...
        <Link href="/login"><span className={styles.button} style={{cursor:"pointer"}}>Login</span></Link>
      </div>
      <div style={{flexGrow:"1"}}>
        <div style={{marginTop:"20vh"}}>
      <h3 style={{fontSize:"48px"}}>Be a part of decision</h3>
        <h1 style={{fontSize:"99px",color:"#015FC7"}}>Vote Today</h1>
        <Link href="/register" ><a className={styles.button}>REGISTER</a></Link>
...
inexpensive, faster results and others.
      ...
      <div className={styles.footer} style={{height:"50vh",display:"flex",justifyContent:"space-evenly",backgroundColor:"#001124",color:"#fff"}}>
          ...
          <div style={{border:"0 3px",borderStyle:"solid",borderColor:"green"}}>Not Great</div>
          <div>So great</div>
      </div>
    </div>
  )
